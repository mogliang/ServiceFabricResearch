		...
		private static void Main()
		{
			try
			{
				...
				using (FabricRuntime fabricRuntime = FabricRuntime.Create())
				{
					...
					fabricRuntime.RegisterServiceType("ProfileMidTierType", typeof(ProfileMidTier));

					ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(ProfileMidTier).Name);
